...
int main(int argc, char *argv[])
{
    ...
    { // parent goes down this path
        ...
        //The parent process creates the child with fork().
        //After the fork, the parent calls wait(NULL), which makes the parent pause and wait for the child process to terminate.
        //Once the child finishes, the parent resumes and prints a message, showing that the child has finished.
